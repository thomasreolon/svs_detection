...
@REM @REM baseline: 
@REM python main.py --exp_name comp_synth/base/grey --architecture yolophi --framerate 4   --simulator grey
@REM python main.py --exp_name comp_synth/base/4fr  --architecture yolophi --framerate 4   --simulator static --svs_close 1 --svs_open 3 --svs_hot 5
@REM python main.py --exp_name comp_synth/base/1fr  --architecture yolophi --framerate 1   --simulator static --svs_close 1 --svs_open 3 --svs_hot 5
@REM python main.py --exp_name comp_synth/base/15fr --architecture yolophi --framerate 15  --simulator static --svs_close 1 --svs_open 3 --svs_hot 5

@REM @REM small models
@REM python main.py --exp_name comp_synth/small/7k  --architecture opt_yolo7  --framerate 4   --simulator static --svs_close 1 --svs_open 3 --svs_hot 5
...
@REM python main.py --exp_name comp_synth/other/mhigrey --architecture yolophi --framerate 4 --simulator mhicatgrey --svs_close 1 --svs_open 3 --svs_hot 5
...
@REM @REM quantize
@REM python main.py --exp_name comp_synth/quant/base --quantize 8bit --architecture yolophi    --framerate 4   --simulator static --svs_close 1 --svs_open 3 --svs_hot 5
