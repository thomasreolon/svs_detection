...
class Annotator:
    ...
    def box_label(self, box, label='', color=(128, 128, 128), txt_color=(255, 255, 255)):
        ...
        if self.pil or not is_ascii(label):
            ...
            if self.im.shape[0]==3:   self.im = torch.tensor(self.im).permute(1,2,0).numpy()
            elif self.im.shape[0]==1: self.im = cv2.cvtColor(torch.tensor(self.im).permute(1,2,0).numpy(), cv2.COLOR_GRAY2BGR)
