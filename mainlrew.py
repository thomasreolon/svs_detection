...
from engine import train_one_epochmap, test_epoch
...
def main(args, device):
    ...
    if not args.skip_train:
        ...
        for epoch in mainpbar:
            ...
            summary, start, mm = train_one_epochmap(tr_loader, model, loss_fn, optimizer, device, epoch, debug, (mm if epoch>80 else 0))
